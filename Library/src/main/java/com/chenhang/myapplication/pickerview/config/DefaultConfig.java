package com.chenhang.myapplication.pickerview.config;
...
public class DefaultConfig {
    ...
    public static final int COLOR = 0XFFB7CAE6;//选中框上下线的颜色
    public static final int RECT_COLOR = 0XFFDEEEFF;//选中框填充的颜色
    public static final int TOOLBAR_TV_COLOR = 0xFFFFFFFF;
    public static final int TV_NORMAL_COLOR = 0xFF999999;
    public static final int TV_SELECTOR_COLOR = 0XFF404040;//选中字体颜色
